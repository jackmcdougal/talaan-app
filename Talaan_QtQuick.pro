...
UBUNTU_TRANSLATION_DOMAIN="talaan.kugiigi"
...
aptest.commands = bash $$PWD/talaan/tests/autopilot/run
aptest.depends  = sub-talaan

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/talaan/tests/unit
